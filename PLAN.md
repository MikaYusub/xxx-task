...
inference idempotency are covered by focused tests. `docs/reviewer-console.html` is the small
reviewer-facing smoke-test UI for the same anonymous Auth and Firestore create path.
